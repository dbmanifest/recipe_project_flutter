...
class RecipeSubmittedWidget extends StatefulWidget {
  ...
  @override
  State<RecipeSubmittedWidget> createState() => _RecipeSubmittedWidgetState();
}

class _RecipeSubmittedWidgetState extends State<RecipeSubmittedWidget>
    with TickerProviderStateMixin {
  late RecipeSubmittedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecipeSubmittedModel());
