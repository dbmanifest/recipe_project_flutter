...
class Recipe1Step6Widget extends StatefulWidget {
  ...
  @override
  State<Recipe1Step6Widget> createState() => _Recipe1Step6WidgetState();
}

class _Recipe1Step6WidgetState extends State<Recipe1Step6Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Recipe1Step6Model());
                          ...
                          child: SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                alignLabelWithHint: false,
                                hintText: 'Container tare weight',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                20.0, 0.0, 0.0, 0.0),
                            child: Text(
                              'Issue the above material to Work Order\n\n',
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
