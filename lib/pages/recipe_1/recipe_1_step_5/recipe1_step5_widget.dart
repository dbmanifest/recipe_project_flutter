                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              20.0, 0.0, 0.0, 0.0),
                          child: Text(
                            'Scan and move excipients) to dispensing area.\nVerify materials are allocated to the Work Order.\nRecord room number where dispensing will occur\n',
                  ...
                  children: [
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Verify balance checks have been completed and documented.\n Record the ID numbers for balance(s).',
                          textAlign: TextAlign.center,
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
